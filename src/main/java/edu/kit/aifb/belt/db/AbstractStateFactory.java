...
public abstract class AbstractStateFactory {
	...
	// For the future, since the domain will be encoded in the action. And we
	// don't want objects with a specific domain, but we want to find the best
	// domain for a specific kind of object.
